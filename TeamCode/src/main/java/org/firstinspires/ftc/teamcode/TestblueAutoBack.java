...
@Autonomous(name = "Red Auto Back Lite")
public class TestblueAutoBack extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(new Pose(144-55.00, 9.790,Math.toRadians(180-110)));
        ...
        PIDFCoefficients tunedPIDF = new PIDFCoefficients(100, 0, 0, 13.0);
...
//    }
    ...
    public void buildPaths() {
        Path1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(144-55.000, 9.790),
                                new Pose(144-50.500, 35.900)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-110), Math.toRadians(180-180))
                .build();
        ...
        Path3 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(144-3.220, 35.90),
                                new Pose(144-56.0, 9.600)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-180), Math.toRadians(180-110))
                .build();
        ...
        Path4 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(144-56.0, 9.600),
                                new Pose(144-35, 19.500)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-110), Math.toRadians(180-195))
                .build();
