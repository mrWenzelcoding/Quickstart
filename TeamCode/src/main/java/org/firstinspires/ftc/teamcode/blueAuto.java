...
//    }
    ...
    public void buildPaths() {
        Path1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(19.500, 123.400),
                                new Pose(52.800, 90.500)
                        )
                )
        ...
        Path3 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                new Pose(49.330, 83.590),
                                new Pose(17.0, 84.000)
                        )
                )
